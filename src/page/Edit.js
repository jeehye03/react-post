...
import reducer, { addPostFB, createPost, updatePost, updatePostFB } from "../redux/modules/post";
...
const Edit = () => {
  ...
  const [imgUrl, setImgUrl] = React.useState(modifyPost ? modifyPost[0].img_url : "");
  console.log(imgUrl)
  ...
  const uploadFile = () => {
    ...
    dispatch(updatePostFB(newPost, post_id));
    navigate('/')
